...
public class OmniDoor implements Tangible {
    ...
    public void unlock(OmniKey key) {
        ...
        //key is given as a param that will open door
        //need to check if the keys pins matches the door's pins at the same index
    ...
    public int getFirstWrongPin(OmniKey key) {
        //check each pin with key with pin in lock, need to match index
        //if the pin is wrong, need to save the wrong index and break!
